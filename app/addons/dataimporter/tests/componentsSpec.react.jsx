...
define([
  ...
  describe('Data Importer -- Components', function () {
    var spy, startContainer, previewContainer, El, dataImportStore, importer, previewScreen;
    ...
    beforeEach(function () {
      ...
      importer = TestUtils.renderIntoDocument(<Components.DataImporterDropZone maxSize={maxSize} />, startContainer);
    });
    ...
    it('should show Loading file page', function () {
      var stub = sinon.stub(dataImportStore, 'papaparse');
    ...
    it('should show a limited preview if the file is larger than 750000 ', function () {
      var stub = sinon.stub(dataImportStore, 'papaparse');

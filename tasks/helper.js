  ...
  return { 
    ...
    check_chrome_driver: {
      command: function () {
        ...
        return 'test -s ./test/nightwatch_tests/selenium/chromedriver || (curl -o ./test/nightwatch_tests/selenium/chromedriver_' + type + '.zip http://chromedriver.storage.googleapis.com/2.9/chromedriver_' + type + '.zip && unzip -o ./test/nightwatch_tests/selenium/chromedriver_' + type + '.zip -d ./test/nightwatch_tests/selenium/ && ls ./test/nightwatch_tests/selenium/)';
      }
    }
  };
};

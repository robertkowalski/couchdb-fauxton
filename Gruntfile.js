...
module.exports = function(grunt) {
  ...
  var couchserver_config  = function () {
    var FAUXTON_CI_DB_HOST = process.env.FAUXTON_CI_DB_HOST,
        USER = process.env.FAUXTON_CI_USER,
        PW = process.env.FAUXTON_CI_PASSWORD,
        EXTERNAL_URL = 'https://' + USER + ':' + PW + '@' + FAUXTON_CI_DB_HOST;
    ...
    var defaults = {
      ...
      port: 8000,
      proxy: {
        target: FAUXTON_CI_DB_HOST ? EXTERNAL_URL : 'http://localhost:5984/'
      }
    };
